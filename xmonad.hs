...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm .|. shiftMask, xK_d     ), spawn "dmenu_run -l 20")
    ...
    , ((modm .|. shiftMask  , xK_g   ), goToSelected def)
    , ((modm .|. shiftMask  , xK_b   ), bringSelected def)
...
myManageHook = composeAll
    ...
    , className =? "Microsoft Teams - Insiders"  --> doShift ( myWorkspaces !! 2 )
...
--        spawnOnce "openrgb --startminimized &"
        spawnOnce "trayer --edge top --align right --widthtype request --padding 15 --SetDockType true --SetPartialStrut true --expand true --transparent true --alpha 127 --tint 0x292d3e --height 30 --iconspacing 8 &"
...
main :: IO ()
main = do
        --xmproc <- spawnPipe "xmobar -x 0 /home/garrett/.config/xmobar/xmobarrc"
        xmonad . ewmhFullscreen . ewmh . withEasySB (statusBarProp "/home/garrett/.cabal/bin/xmobar -x 0 /home/garrett/.config/xmobar/xmobarrc" (clickablePP myXmobarPP)) defToggleStrutsKey $ myConfig
